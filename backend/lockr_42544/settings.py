"""
Django settings for lockr_42544 project.
...
WSGI_APPLICATION = 'lockr_42544.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lockr_42544 API",
    "DESCRIPTION": "API documentation for lockr_42544 App",
    "VERSION": "v1",
}
